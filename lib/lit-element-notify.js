/*
MIT License by https://github.com/morbidick <mail@morbi-happens.de>
see https://github.com/morbidick/lit-element-notify/blob/master/package.json

Modified by Stefan Grönke <stefan@gronke.net>
*/
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const r$1=(i,t)=>{var s,e;const o=i.N;if(void 0===o)return !1;for(const i of o)null===(e=(s=i).O)||void 0===e||e.call(s,t,!1),r$1(i,t);return !0},o$1=i=>{let t,s;do{if(void 0===(t=i.M))break;s=t.N,s.delete(i),i=t;}while(0===(null==s?void 0:s.size))},h$1=i=>{for(let t;t=i.M;i=t){let s=t.N;if(void 0===s)t.N=s=new Set;else if(s.has(i))break;s.add(i),d$2(t);}};function n$1(i){void 0!==this.N?(o$1(this),this.M=i,h$1(this)):this.M=i;}function l$1(i,t=!1,s=0){const e=this.H,h=this.N;if(void 0!==h&&0!==h.size)if(t)if(Array.isArray(e))for(let i=s;i<e.length;i++)r$1(e[i],!1),o$1(e[i]);else null!=e&&(r$1(e,!1),o$1(e));else r$1(this,i);}const d$2=i=>{var t$1,e,r,o;i.type==t.CHILD&&(null!==(t$1=(r=i).P)&&void 0!==t$1||(r.P=l$1),null!==(e=(o=i).Q)&&void 0!==e||(o.Q=n$1));};class c$1 extends s{constructor(){super(...arguments),this.isConnected=!0,this.ut=w,this.N=void 0;}T(i,t,s){super.T(i,t,s),h$1(this);}O(i,t=!0){this.at(i),t&&(r$1(this,i),o$1(this));}at(t){var s,e;t!==this.isConnected&&(t?(this.isConnected=!0,this.ut!==w&&(this.setValue(this.ut),this.ut=w),null===(s=this.reconnected)||void 0===s||s.call(this)):(this.isConnected=!1,null===(e=this.disconnected)||void 0===e||e.call(this)));}S(i,t){if(!this.isConnected)throw Error(`AsyncDirective ${this.constructor.name} was rendered while its tree was disconnected.`);return super.S(i,t)}setValue(i){if(this.isConnected)if(d$1(this.Σdt))this.Σdt.I(i,this);else {const t=[...this.Σdt.H];t[this.Σct]=i,this.Σdt.I(t,this,0);}else this.ut=i;}disconnected(){}reconnected(){}}

class LitSyncDirective extends c$1 {
    get property() {
        throw new Error("not implemented");
    }
    constructor(part) {
        super();
        const eventName = eventNameForProperty(part.name);

        //const notifyingElement = part.options.host;
        this.notifyingElement = part.element;
        this.notifiedElement = part.options.host;
        this.notifyingProperty = part.name;

        let syncInitialized = false;

        this.notifyingElement.addEventListener(eventName, (e) => {
            ...
            const oldValue = this.notifiedElement[this.property];
            this.notifiedElement[this.property] = e.detail.value;
            if (this.notifiedElement.__lookupSetter__(this.property) === undefined) {
                this.notifiedElement.updated(new Map([[this.property, oldValue]]));
            }
        });
    }
    update(part) {
        part.element[part.name] = this.notifiedElement[this.property];
        return this.render();
    }
    render() {
        return this.notifiedElement[this.property];
    }
}
...
const LitSync = (baseElement) => class extends baseElement {
    constructor() {
         ...
         */
        this.sync = (property, foo) => {
            class D extends LitSyncDirective {
                get property() {
                    return property;
                }
            }
